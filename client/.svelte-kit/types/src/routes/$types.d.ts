...
type LayoutRouteId = RouteId | "/" | "/app" | "/app/member-issues/[userId]" | "/app/members" | "/app/my-issues" | "/app/notifications" | "/app/project/[projectId]" | "/app/project/[projectId]/issue/[taskId]" | "/auth/callback" | "/auth/google-callback" | "/error/500" | "/login" | null
type LayoutParams = RouteParams & { userId?: string; projectId?: string; taskId?: string }
