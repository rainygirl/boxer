...
# Frontend build (served by WhiteNoise at root)
FRONTEND_BUILD_DIR = BASE_DIR.parent / 'client' / 'build'
...
SOCIALACCOUNT_ADAPTER = 'accounts.adapters.BoxerSocialAccountAdapter'
